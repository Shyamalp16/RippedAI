...
const Diet = () => {
  ...
  const getData = async () => {
    try {
      ...
      if (data && data.target_macros) {
        setMacros(prevMacros => ({
          ...prevMacros,
          calories: { ...prevMacros.calories, target: data.target_macros.calories },
          protein: { ...prevMacros.protein, target: data.target_macros.protein },
          carbs: { ...prevMacros.carbs, target: data.target_macros.carbs },
          fat: { ...prevMacros.fat, target: data.target_macros.fats }, // Note: 'fats' in response
          iron: { ...prevMacros.iron, target: data.target_macros.iron },
        }));
      }
    } catch (e) {
      console.error(e)
